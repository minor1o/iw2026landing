...
(() => {
  ...
  var railBtns = Array.prototype.slice.call(
    document.querySelectorAll("#rail button"),
  );
  var sections = railBtns.map((b) => document.getElementById(b.dataset.go));
  railBtns.forEach((b) => {
  ...
  var cio = new IntersectionObserver(
    (entries) => {
      entries.forEach((e) => {
        ...
        if (reduce) el.textContent = target + suffix;
