...
/* ---------- cost calculator ---------- */
  var herd = document.getElementById("herd"), miss = document.getElementById("miss");
  function fmt(n){ return n.toLocaleString("en-US"); }
  function calc(){
    var h = +herd.value, m = +miss.value / 100;
  ...
  if (herd && miss){ herd.addEventListener("input", calc); miss.addEventListener("input", calc); calc(); }
